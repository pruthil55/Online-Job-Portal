...
<html lang="en">
  <head>
    ...
    <link href="css/A_Questions.css" rel="stylesheet">
  ...
  <body id="myPage" data-offset="60">
    ...
    <div class="cantainer-fluid">
      <p style="color: black;font-size: 23px;line-height: 25px;font-weight: 400;margin: 20px auto;">Assessment questions</p>
      <p style="font-weight: 600;line-height: 15px;margin-top: 30px;font-size: 15px;">Why should you be hired for this job?</p>
      <p style="font-weight: 600;color: #808081;line-height: 15px;font-size: 15px;">Please answer this question carefully. It will increase your chances of getting hired.</p>
      <form action="php/appliedApplication.php?job=<?php if(isset($_GET['job'])){ echo $_GET['job']; } ?>" method="post">
        <div class="form-group">
          <textarea class="form-control" name="qa_1" rows="6" placeholder="Mention in detail what relevant skill or past experience you have for this job. What excites you about this job?. How this job accelerate your career?."></textarea>
        </div>

        <p style="font-weight: 600;line-height: 15px;margin-top: 30px;font-size: 15px;">What are you expect from us (company)?</p>
        <p style="font-weight: 600;color: #808081;line-height: 15px;font-size: 15px;">We want to know what can we do for our employees.</p>
        <div class="form-group">
          <textarea class="form-control" name="qa_2" rows="6" placeholder="Mention your expectation if not then leave it blank."></textarea>
        </div>

        <div align="center" style="margin-bottom: 20px;">
          <button type="submit" name="submit" class="btn" style="background-color: #9FABFF;border: 1px solid #9FABFF;color: #fff;padding-bottom: 9px;">Submit</button>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  ...
  function submit() {
    location.href = "successornot.php";
  }
</script>
